...
// intermediate CA Secrets and Certificates in any namespace. The Secret watch
// triggers independent-intermediate-rotation detection regardless of which
// namespace the intermediate CA lives in.
//
...
// restricted to cert-manager (trust-manager Bundle output and the operator's
// own staging ConfigMap both live there).
