...
> **Related guides:**
> [Issuing TLS Certificates via an Intermediate CA](../cert-manager-extensions/user-guide.md) — namespace intermediate CA setup and leaf certificate issuance
...
cause of the [QAC incident on 2026-02-20](../../architecture/01-problem-statement/README.md).
...
- [Issuing TLS Certificates via an Intermediate CA](../cert-manager-extensions/user-guide.md) — how
  to create a namespace intermediate CA and issue leaf certificates from it
