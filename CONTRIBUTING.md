...
`docs/` holds ADRs, design plans, and per-feature operator manuals/user
guides for the two components in this repo (`private-pki-operator`,
`cert-manager-extensions`). Keep them in sync with code changes that affect
